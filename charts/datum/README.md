...
| ingress.openfga.datastore.engine | string | `"memory"` |  |
| ingress.openfga.experimentals[0] | string | `"check-query-cache"` |  |
| ingress.openfga.playground.enabled | bool | `false` |  |
| ingress.openfga.replicaCount | int | `1` |  |
